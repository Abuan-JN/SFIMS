                    ...
                    <ul class="navbar-nav align-items-center flex-row">
                        ...
                        <li class="nav-item dropdown me-3">
                            <a class="nav-link position-relative p-0" href="#" id="activityDropdown" data-bs-toggle="dropdown" onclick="markAsRead()">
                                ...
                                <span id="notif-red-dot" class="position-absolute top-0 start-100 translate-middle p-1 bg-danger border border-light rounded-circle d-none"></span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-end py-0 overflow-hidden" style="width: 320px;">
                                ...
                                <div class="overflow-auto" style="max-height: 350px;">
                                    <?php 
                                    $recentLogs = $db->query("SELECT * FROM audit_logs ORDER BY timestamp DESC LIMIT 8")->fetchAll();
                        ...
                        <li class="nav-item dropdown border-start ps-3">
                            ...
                            <ul class="dropdown-menu dropdown-menu-end">
                                ...
                                <li><hr class="dropdown-divider"></li>
                                <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>profile.php"><i class="bi bi-gear-fill"></i> Settings</a></li>
    ...
    <div class="app-container">
        <aside class="sidebar d-none d-md-flex">
            ...
            <nav class="sidebar-menu">
                <a href="<?php echo BASE_URL; ?>dashboard.php" class="sidebar-link active"><i class="bi bi-speedometer2"></i> Overview</a>
                <a href="<?php echo BASE_URL; ?>staff/items_add.php" class="sidebar-link"><i class="bi bi-plus-circle-fill"></i> New Item</a>
                <a href="<?php echo BASE_URL; ?>staff/receive.php" class="sidebar-link"><i class="bi bi-arrow-down-square-fill"></i> Receive Stock</a>
                <a href="<?php echo BASE_URL; ?>staff/disburse.php" class="sidebar-link"><i class="bi bi-arrow-up-square-fill"></i> Disburse Stock</a>
                <a href="<?php echo BASE_URL; ?>reports/reports.php" class="sidebar-link"><i class="bi bi-bar-chart-line-fill"></i> System Reports</a>
