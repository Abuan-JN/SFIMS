# SPMO PLMun Setup Guide (XAMPP)

Follow these steps to set up the **Supply and Property Management Office (SPMO PLMun)** on your local environment.
...
1. Copy the project folder into your XAMPP's `htdocs` directory:
    - Path: `C:\xampp\htdocs\sfims` (or your chosen folder name)
